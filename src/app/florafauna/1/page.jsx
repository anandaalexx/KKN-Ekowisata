...
const rhinoData = {
  title: "Rhinoceros",
  images: ["/images/macan.jpg", "/images/monkey.png"],
  breadcrumb: [
  ...
  content: {
    ...
    taxonomy: [
      "Content for Taxonomy tab... Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quae.",
    ],
    evolution: [
      "Content for Evolution tab... Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quae.",
    ],
    biology: [
      "Content for Biology tab... Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quae.",
    ],
    behavior: [
      "Content for Behavior tab... Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quae.",
    ],
    ecology: [
      "Content for Ecology tab... Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quae.",
    ],
    roles: [
      "Content for Roles with humans tab... Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quae.",
    ],
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-3/5">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center bg-[#2D3748] rounded-md p-1 shadow-md">
                {" "}
                {/* Warna gelap dari panel filter sebelumnya, rounded-full */}
                <button
            ...
            <div className="space-y-4 text-sm sm:text-base leading-relaxed text-gray-300 prose prose-sm prose-invert max-w-none">
              {" "}
              {/* Styling prose untuk teks */}
              {(rhinoData.content[activeTab] || ["Konten tidak tersedia."]).map(
                (paragraph, index) => (
